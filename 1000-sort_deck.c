 ...
 * @d1: Represents the first string to be compared.
 * @d2: Represents the second string to be compared.
 *
 * Return: Positive byte difference if d1 > d2
 *         0 if d1 == d2
 *         Negative byte difference if d1 < d2
 */
int _strcmp(const char *d1, const char *d2)
{
	while (*d1 && *d2 && *d1 == *d2)
